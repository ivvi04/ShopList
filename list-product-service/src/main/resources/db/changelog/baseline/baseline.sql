...
ALTER TABLE IF EXISTS list_product_service.lists OWNER to list_product_service;
...
ALTER TABLE IF EXISTS list_product_service.list_users OWNER to list_product_service;
